					...
					<br>
						...
						<tr>
							<td><input type="text" name="mobile_number" required/><td>
								<input type="hidden" name="doc_type" value="brgy_cert"/>
						</tr>
						</table>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rtu-management-sys-api\resources\views/services/brgy_cert.blade.php ENDPATH**/ ?>