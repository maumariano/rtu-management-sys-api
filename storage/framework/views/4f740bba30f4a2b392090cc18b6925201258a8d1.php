            ...
            <div class="center__p">
               <div class="testbox">
				  <form action="<?php echo e(route('brgy_cert')); ?>" method="post">
					  <?php echo csrf_field(); ?>
					<div class="banner__p">
					  <h1>Permit for Telecommunication</h1>
					</div><br>
					<div class="note1">
					...
					<br>
						...
						<tr>
							<td><input type="text" name="mobile_number" required/><td>
								<input type="hidden" name="doc_type" value="permit"/>
						</tr>
						</table>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rtu-management-sys-api\resources\views/services/permit.blade.php ENDPATH**/ ?>